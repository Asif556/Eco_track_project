...
const Fregister = () => {
  ...
  return (
    <div className="h-full w-full flex justify-center flex-wrap lg:flex-nowrap absolute bg-gradient-to-t from-transparent to-[#C0F2CB] p-6 min-h-screen">
      <div className="w-full lg:w-1/3 flex flex-col">
        ...
        <div className="flex flex-grow justify-center items-center w-full">
          <div className="bg-transparent border p-6 rounded-xl shadow-lg w-full max-w-2xl">
            <h2 className="text-2xl font-semibold text-gray-800 text-center">Get Started</h2>
            <p className="text-gray-500 mb-4 text-center">Create your account now</p>
            ...
            <div className="mt-4 flex flex-col items-center">
              ...
              <button 
                ...
                className="mt-2 flex items-center gap-2 border px-5 py-3 rounded-full text-gray-700 shadow-md"
              >
      ...
      <div className="w-full lg:w-2/3 flex items-center justify-center mt-10 lg:mt-0">
        <div className="text-center">
          ...
          <div className="text-2xl sm:text-3xl font-semibold mt-4">Join Our Green Community</div>
          <div className="text-lg text-gray-700 mt-2">
            Register to access smart farming tools, expert advice, and <br />
